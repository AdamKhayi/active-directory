...
<p>  
  Create a new File and paste the contents of this script (https://github.com/AdamKhayi/active-directory/blob/main/createUsers.ps1) into it:
</p>
<p>
...
<br />
<p>
  Since we are done, proceed to clean up your environment so that you do incur additional charges.
</p>
<p>
  Close your Remote Desktop connection, delete the Resource Group(s) created at the beginning of this tutorial, and make sure that the Resource Group is deleted.
</p>
